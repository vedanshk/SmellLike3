...
public class DirectionFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        directions =  Recipes.directions[position].split("`");
        ...
        if(savedInstanceState != null){
            ...
            setUpCheckBoxes(directions , linearLayout , stateOfCheckedBox);
        }else{
            setUpCheckBoxes(directions , linearLayout , null);
        }
    ...
    private void setUpCheckBoxes(String[] directions , LinearLayout container, boolean[] stateOfCheckedBox){
        int i = 0;
